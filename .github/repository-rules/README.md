...
- `main-branch-protection.json` protects `main`, requires a pull request with an approval from the repository owner via CODEOWNERS, allows the owner to override rules as an admin, and prevents force pushes and branch deletion.
